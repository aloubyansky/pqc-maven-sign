    ...
    void inspectGpgBlock_processesEachBlockIndependently() throws Exception {
        ...
        try {
            ...
            java.lang.reflect.Method method = SignatureInspector.class.getDeclaredMethod(
                    ...
                    io.github.aloubyansky.sigmund.core.AscCombiner.SignaturePacketInfo.class,
                    java.nio.file.Path.class);
            method.setAccessible(true);

            var pktInfo = new io.github.aloubyansky.sigmund.core.AscCombiner.SignaturePacketInfo(4, 17, null);
