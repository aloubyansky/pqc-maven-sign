...
public record TrustConfig(
     ...
     * <ul>
     * <li><b>Minimal:</b> an email string (e.g. {@code "jane@example.com"})</li>
     * <li><b>Short:</b> an object with {@code gpg}/{@code pqc}/{@code email} directly</li>
    ...
    /**
     * A single signer credential with optional GPG fingerprint, PQC fingerprint, and email.
     * At least one of the three fields is always present.
     */
    public record Member(String gpg, String pqc, String email) {
    }
}
